# Contributing to snapdragon-position

First and foremost, thank you! We appreciate that you want to contribute to snapdragon-position, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for snapdragon-position**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for snapdragon-position:

- star the [project](https://github.com/jonschlinkert/snapdragon-position)
- tweet your support for snapdragon-position
...
- **version**: please note the version of snapdragon-position are you using
...
[so]: http://stackoverflow.com/questions/tagged/snapdragon-position